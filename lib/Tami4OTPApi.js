...
const GENERATE_OTP_URL = "https://swelcustomers.strauss-water.com/public/phone/generateOTP";
const SUBMIT_OTP_URL   = "https://swelcustomers.strauss-water.com/public/phone/submitOTP";
...
class Tami4OTPApi {
    ...
    */
    async sendOTPSMS(phoneNumber) {
        ...
        try {
            await this.#getPost.sendPostRequest(GENERATE_OTP_URL,body,{"Content-Type": "application/json"});
        } catch (err) {
    ...
    */
    async getTokenByOTP(phoneNumber,OTP) {
        ...
        var resp;
        try {
            resp = await this.#getPost.sendPostRequest(SUBMIT_OTP_URL,body,{"Content-Type": "application/json"});
        } catch (err) {
